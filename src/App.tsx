...
const App = () => {
  ...
  return (
    <div className="container">
      ...
      <div className="flex">
        {/* Se o isPlay for true(inicia como false), então vai mudar o texto do botão para Pause, caso contrário, vai mudar o texto do botão para Play. */}
        <button onClick={play}>{isPlay ? "Pause" : "Play"}</button>
        <button onClick={forward}>+ 2s</button>
        {/* Se o isPlaybackRate for true(inicia como false), então vai mudar o texto do botão para 2X, caso contrário, vai mudar o texto do botão para 1X. */}
        <button onClick={playbackRate}>{isPlaybackRate ? "2X" : "1X"}</button>
        <button onClick={pictureInPicture}>PiP</button>
        {/* Se o isMuted for true(inicia como false), então vai mudar o texto do botão para D, caso contrário, vai mudar o texto do botão para M. */}
